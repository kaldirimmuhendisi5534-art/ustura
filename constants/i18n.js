...
export const T = {
  ...
  tr: {
    ...
    apt_book:         'Randevu Al',
    apt_cancel:       'İptal',
    apt_cancel_no:    'Vazgeç',
    apt_cancel_yes:   'İptal Et',
    apt_cancel_ok:    'Randevu iptal edildi.',
  ...
  fr: {
    ...
    apt_cancel:       'Annuler',
    apt_cancel_no:    'Retour',
    apt_cancel_yes:   'Annuler',
    apt_cancel_ok:    'Rendez-vous annulé.',
